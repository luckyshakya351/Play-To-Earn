  ...
  return (
    <Layout>
      <Container sx={style.container}>
        ...
        <Box sx={{ width: '95%', marginLeft: '2.5%', background: zubgtext, borderRadius: '10px', padding: '10px', mt: '10px', }}>
          <Box component={'img'} src={Giftimg} sx={{ width: '100%', height: '23 vh' }}></Box>
        </Box>
        <Box sx={{ width: '95%', marginLeft: '2.5%', background: zubgtext, borderRadius: '10px', padding: '10px', mt: '10px', }}>
          <Typography variant="body1" color="initial" sx={{ color: 'white' }} className="loginlabel">Hi</Typography>
          <Typography variant="body1" color="initial" sx={{ color: 'white' }} className="loginlabel">We have a gift for you</Typography>
